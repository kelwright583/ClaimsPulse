...
export default function TatPage() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-16">
        <div className="text-sm text-[#6B7280]">Loading TAT watchlist...</div>
      </div>
    );
  }
  ...
  if (!data) {
    return (
      <div className="bg-white border border-[#E8EEF8] rounded-xl p-8 text-center">
        <p className="text-sm text-[#6B7280]">Failed to load TAT data.</p>
      </div>
    );
  }
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-[#0D2761]">TAT Watchlist</h1>
        {data.snapshotDate && (
      ...
      {sortedGroups.length === 0 ? (
        <div className="bg-white border border-[#E8EEF8] rounded-xl p-12 text-center shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
          ...
          <p className="text-sm text-[#6B7280]">No TAT breaches in the current snapshot.</p>
        </div>
      ) : (
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-[#6B7280]">TAT: {group.maxDays} days</span>
                  </div>
                  <div className="flex items-center gap-3">
